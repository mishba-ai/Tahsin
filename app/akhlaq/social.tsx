...
const social = () => {
  return (
    ...
    <View className='w-12 h-12 absolute  left-1 top-32'>
      <Image source={images.m6} className='w-[390px] bg-no-repeat  h-[628px] opacity-20'  resizeMode='cover' />
    </View>
      <Text className='text-4xl font-bold text-lime-700'>Honesty</Text>
    </View>
  </View>
  )
}
